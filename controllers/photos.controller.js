...
exports.add = async (req, res) => {
  ...
  try {
    ...
    if(title && author && email && file) { // if fields are not empty...
      ...
      const welcomedTypes = ['jpg', 'jpeg', 'png', 'bmp', 'gif'];
      if (welcomedTypes.indexOf(fileExtension) >= 0 && title.length <= 25 && author.length <= 50 && email.split('@').length === 2) {
